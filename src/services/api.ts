...
export const api = {
  ...
  crearUsuario(datos: NuevoUsuario): Promise<Usuario> {
    return pedir<Usuario>('/usuarios', { method: 'POST', body: datos })
  },
  actualizarUsuario(id: string, datos: NuevoUsuario): Promise<Usuario> {
    return pedir<Usuario>(`/usuarios/${id}`, { method: 'PUT', body: datos })
  },
  eliminarUsuario(id: string): Promise<void> {
    return pedir<void>(`/usuarios/${id}`, { method: 'DELETE' })
  },
