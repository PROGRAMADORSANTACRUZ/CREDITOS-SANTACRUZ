...
export async function enviarLinkSolicitud(
  ...
  const html = `
    <div style="font-family:Arial,sans-serif;max-width:520px;margin:auto;color:#0f172a">
      ...
      <p>Hola,</p>
      <p>Has sido invitado a diligenciar tu <strong>Solicitud de crédito</strong>.
      Haz clic en el siguiente botón para completar el formulario:</p>
  ...
  await getTransporter().sendMail({
    ...
    to: destino,
    subject: 'Solicitud de crédito - Grupo Santacruz',
    html,
  })
}
